  ...
  render() {
    ...
    return (
      <div className="about-cart">
        ...
        <h3>
          Welcome to MJ Food, your go-to destination for delicious meals
          delivered fresh to your doorstep. We believe great food brings people
          together, and our mission is to make every bite memorable.
        </h3>
        <h3>
        ...
        <h2>Our Mission 🚀</h2>
        <h3>
          To bring you flavorful, hygienic, and affordable food anytime,
          anywhere. We aim to provide a smooth online ordering experience and
          fast delivery so you can enjoy your favorite dishes without hassle.
        </h3>
        ...
        {/* <UserClass name="first (Owner Class-based)" Locality="NewYork" /> */}
        <User />
      </div>
    );
  }
