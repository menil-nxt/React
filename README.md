...
# More Dipper Knowlage of Lifecycle
...
- componentDidUpdate (every setState variable is update at that time componentDidUpdate is called)
- componentWillUnmount(when you leave a page at that time componentWillUnmount is called)
